...
# Música de espera — URLs de Twilio CDN que funcionan
HOLD_MUSIC_1 = "https://com.twilio.sounds.music.s3.amazonaws.com/MARKOVICHP_-_A_Wonderful_Feeling.mp3"
HOLD_MUSIC_2 = "https://com.twilio.sounds.music.s3.amazonaws.com/MOROBOSHI_-_Phi.mp3"
...
def hold_sequence() -> str:
    ...
    return f"""
    <Play loop="1">{HOLD_MUSIC_1}</Play>
    {hold_announce("Gracias por su paciencia. Todos nuestros representantes están ocupados. Su llamada es muy importante para nosotros. Por favor continúe en espera.")}
    <Pause length="1"/>
    <Play loop="2">{HOLD_MUSIC_2}</Play>
    {hold_announce("Le recordamos que también puede obtener asistencia inmediata a través de nuestro bot de Telegram, disponible las veinticuatro horas del día, los siete días de la semana.")}
    <Pause length="1"/>
    <Play loop="1">{HOLD_MUSIC_1}</Play>
"""
